...
% shading flat
% colorbar
% title('B. Phytoplankton growth over time [mmol Nitrogen m⁻3]','FontSize', 20)
...
% shading flat
% colorbar
% title('B. Nutrient concentration over time [mmol Nitrogen m⁻3]','FontSize', 20)
% xlabel('Time [days]','FontSize', 16)
% ylabel('Depth [meters]','FontSize', 16)
% 
% figure; 
...
% shading flat
% colorbar
% title('B. Detritus concentration over time [mmol Nitrogen m⁻3]','FontSize', 20)
% xlabel('Time [days]','FontSize', 16)
% ylabel('Depth [meters]','FontSize', 16)
...
title('B. Steady state solution for the state variables, time=3000 days','FontSize',12)

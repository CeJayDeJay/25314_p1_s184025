...
% title('A. SS-sol for the state variables with seasonality of I, time=5000 days','FontSize',12)
% 

s = 0.4118*cos(2*pi/365*t)+1; 
figure;
plot(t,s,'m','LineWidth', 3)
title('Seasonality curve', 'FontSize', 20)
xlabel('Time [days]', 'FontSize', 16)
ylabel('Seasonality light intensity magnitude', 'FontSize', 16)
xlim([0 365])
%% functions
